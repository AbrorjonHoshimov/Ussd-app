...
import com.example.ussdapp.payload.DetailsDTO;
import com.example.ussdapp.repository.DetailsRepository;
...
//    GenerateExcel generateExcel;
    ...
    public ApiResponse save(UUID id, DetailsDTO detailsDTO) {
        ...
        Optional<SimCard> byId;
        byId = simcardRepository.findById(id);
